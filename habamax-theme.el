...
(let
    ((color-fg "#000000")
     ...
     (color-type "#0070af")	;; added by decameron
...
;;; standard faces
   ...
   '(mode-line ((t (:background "#bfbfbf" :foreground "#406582" :box (:line-width 1 :color "#bfbfbf")))))
   ...
   '(mode-line-inactive ((t (:background "#e5e5e5" :foreground "#505552" :box (:line-width 1 :color "#bfbfbf")))))
   ...
   `(font-lock-comment-face ((t (:foreground ,color-comment)))) ;; color-comment :slant italic
   `(font-lock-keyword-face ((t (:foreground ,color-type))))
