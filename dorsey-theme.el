...
(let ((dorsey-background        "#252727")
  ...
  (custom-theme-set-faces
   ...
   ;; FIXME, TODO, etc
   `(font-lock-warning-face ((t (:foreground ,dorsey-warning))))

   
   ;; Variables
   `(font-lock-variable-name-face ((t (:foreground ,dorsey-foreground))))
